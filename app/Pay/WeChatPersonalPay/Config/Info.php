...
return [
    ...
    'author' => '荔枝',
    'website' => '#',
    'icon' => 'https://tencent.3rd.mcycdn.com/resource/icon/WeChatPersonalPay.png',
    'description' => '依赖通用扩展：微信支付(个人挂机版)。收款账号在本页「配置」里管理，一套配置=一个微信收款账号=一台挂机手机，支持多套；挂机端 App 无需升级',
    'options' => [
        "qrcode" => '二维码',
        "phone" => '手机号转账',
        "reward" => '赞赏码'
