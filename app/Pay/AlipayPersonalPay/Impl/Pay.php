...
class Pay extends Base implements \App\Pay\Pay
{
    ...
    public function trade(): PayEntity
    {
        ...
        //把本支付接口绑定的那套收款配置传下去：2.0 起一套配置=一个支付宝收款账号=一台挂机手机
    ...
    {
        try {
            foreach (\App\Util\PayProfile::list('AlipayPersonalPay') as $profile) {
                $raw = \App\Util\PayProfile::raw('AlipayPersonalPay', (int)$profile['id']);
