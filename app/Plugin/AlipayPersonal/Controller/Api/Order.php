...
namespace App\Plugin\AlipayPersonal\Controller\Api;
...
class Order extends UserPlugin
{
    ...
    {
        /**
         * @var \App\Plugin\AlipayPersonal\Service\Order $order
         */
        $order = Di::inst()->make(\App\Plugin\AlipayPersonal\Service\Order::class);
